...
layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    html.H1("Flight Analytics Dashboard", style={
        "textAlign": "center", 
    ...
    html.Hr(),
    dcc.Dropdown(
        options=['Layover_Label', 'Arrival_Region', 'Departure_Region', 'Arrival_Time_Label', 
                'Departure_Time_Label', 'Arrival_Season', 'Departure_Season', 
                'Duration_Label', 'Seating_Class', 'Airline_Name'],
